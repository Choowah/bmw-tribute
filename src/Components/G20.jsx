        ...
        <div>
            ...
            <div className="bg-white text-black grid grid-cols-2 grid-rows-2 gap-[2vw] justify-items-center items-center mx-[4vw] p-[4vw] rounded-xl">
                ...
                <div>
                    ...
                    <p>Google’s AI Asisstant can now make real phone calls and schedule appointments, “Avengers: Infinity War” comes to the big screen, and construction of the Jeddah Tower – soon to be the world’s tallest building – is well underway. </p>
                </div>
                <div>
